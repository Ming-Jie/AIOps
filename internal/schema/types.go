...
var DefaultSkillCategory = map[string]string{
	...
	"builtin_skill.cisco_ios":                 SkillCategoryReadRemote,
	"builtin_skill.devtool":                   SkillCategorySafe,
	"builtin_skill.code_review":               SkillCategorySafe,
	"builtin_skill.sql_explain":               SkillCategorySafe,
	"builtin_skill.jwt_tool":                  SkillCategorySafe,
	"builtin_skill.password_strength_checker": SkillCategorySafe,
	"builtin_skill.secrets_scanner":           SkillCategorySafe,
	"builtin_skill.security_headers_checker":  SkillCategoryReadRemote,
	"builtin_skill.api_security_checker":      SkillCategorySafe,
	"builtin_skill.log_security_analyzer":     SkillCategorySafe,
	"builtin_skill.crypto_tool":               SkillCategorySafe,
...
var DefaultSkillRiskLevel = map[string]string{
	...
	"builtin_skill.cisco_ios":                 RiskLevelLow,
	"builtin_skill.devtool":                   RiskLevelLow,
	"builtin_skill.code_review":               RiskLevelLow,
	"builtin_skill.sql_explain":               RiskLevelLow,
	"builtin_skill.jwt_tool":                  RiskLevelLow,
	"builtin_skill.password_strength_checker": RiskLevelLow,
	"builtin_skill.secrets_scanner":           RiskLevelLow,
	"builtin_skill.security_headers_checker":  RiskLevelLow,
	"builtin_skill.api_security_checker":      RiskLevelLow,
	"builtin_skill.log_security_analyzer":     RiskLevelLow,
	"builtin_skill.crypto_tool":               RiskLevelLow,
